...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_settings_twitter_card" AS ENUM('summary', 'summary_large_image', 'app', 'player');
  ...
  CREATE TABLE "settings_default_keywords" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "settings" (
  	...
  	"twitter_card" "enum_settings_twitter_card" DEFAULT 'summary_large_image',
  	...
  	"safari_pinned_tab_icon_id" integer,
  	"theme_color" varchar,
  	"organization_name" varchar,
  	"organization_logo_id" integer,
  	"schema_json_ld" varchar,
  ...
  ALTER TABLE "settings_default_keywords" ADD CONSTRAINT "settings_default_keywords_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."settings"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "settings" ADD CONSTRAINT "settings_safari_pinned_tab_icon_id_media_id_fk" FOREIGN KEY ("safari_pinned_tab_icon_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "settings_default_keywords_order_idx" ON "settings_default_keywords" USING btree ("_order");
  CREATE INDEX "settings_default_keywords_parent_id_idx" ON "settings_default_keywords" USING btree ("_parent_id");
  ...
  CREATE INDEX "settings_safari_pinned_tab_icon_idx" ON "settings" USING btree ("safari_pinned_tab_icon_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "settings_default_keywords" CASCADE;
  DROP TABLE "settings" CASCADE;
  DROP TYPE "public"."enum_settings_twitter_card";`)
}
